...
const nextConfig: NextConfig = {
   ...
   *   - Everything else — no-store. HTML contains references to the
   *     exact CSS/JS hashes of its build. Reusing it across a cPanel
   *     deploy can point the browser at assets that have already been
   *     replaced, leaving the application unstyled and unable to hydrate.
   *
   *   Versioned /_next/static assets keep Next.js' own immutable cache.
   *   Pages and route payloads always come from the active Passenger
   *   process, so their build ID can never drift from those assets.
   *
