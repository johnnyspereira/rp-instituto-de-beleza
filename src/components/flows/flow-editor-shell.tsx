...
import { GitFork, HelpCircle, List } from 'lucide-react';
...
export function FlowEditorShell({ initialFlow, initialNodes }: Props) {
  ...
  const [guideOpen, setGuideOpen] = useState(() => initialNodes.length === 0);
        ...
        {!isMobile && (
          <div className="flex items-center gap-4 px-6 py-3.5">
            ...
            <button
              ...
              className="border-border bg-card text-muted-foreground hover:bg-muted hover:text-foreground inline-flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-[12.5px] font-medium transition-colors"
            >
