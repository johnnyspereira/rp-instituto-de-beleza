...
describe('interactivePayloadToText', () => {
  it('flattens reply buttons into QR-sendable text', () => {
    expect(
      interactivePayloadToText({
        ...validButtons,
        header: 'Header',
  ...
  it('flattens list sections into QR-sendable text', () => {
    expect(interactivePayloadToText(validList)).toBe(
