                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-muted-foreground truncate text-xs">
                      {tBuilder(
                        `triggers.${log.trigger_event as AutomationTriggerType}.label`
                      )}{' '}
                  ...
                  <div className="text-muted-foreground text-xs">
                    {formatRelativeLogLabel(log.created_at, t)}
                  </div>
                </button>
                {isOpen && (
...
function formatRelativeLogLabel(
  ...
  return (
    <li className="flex items-start gap-2 text-xs">
      ...
      <span className="text-muted-foreground">
        {tBuilder(`steps.${result.step_type as AutomationStepType}`)}
      </span>
      {result.detail && (
