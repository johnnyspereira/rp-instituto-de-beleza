...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Verifique a URL ou peça para quem convidou enviar um novo.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta para enviar um novo link — ele leva apenas alguns segundos para ser gerado.',
  },
  server_error: {
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="text-muted-foreground space-y-2 py-2 text-xs">
              <p>
                ...
                , saia e crie uma conta novamente com um e-mail diferente. O
                link de convite permanece válido enquanto não expirar.
              </p>
            </div>
