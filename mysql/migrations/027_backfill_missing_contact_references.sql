-- Contacts created after migration 017 (notably through the QR inbox)
-- could still miss their sequential client reference. Fill only blanks and
-- preserve every reference entered or imported manually.
